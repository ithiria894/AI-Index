...
1. Check AI_INDEX.md — navigation only, not the single source of truth
...
- Navigation only. Do not treat as the single source of truth.
...
- 明確寫「not source of truth」或者「code is the single source of truth」
